...
- \`ai_suggested_answer\`: 针对该轮问题的范例答案(150~300 字),**用第一人称、候选人口吻直接作答**,像本人在面试现场说出来的一段话。**严禁**任何前缀引导语(如"你可以这样答""建议这样回答""可以说"等),开头直接进入答案内容。要点:对齐岗位 / 框架,体现 STAR / 决策推演 / 业务直觉等结构,不要直接复述候选人原话。
